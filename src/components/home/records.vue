<template>
	<div id="records">
		<div>
			<div>
				<el-input placeholder="根据用户名过滤" prefix-icon="el-icon-search" v-model="queryFrom.requestUser"></el-input>
				<el-date-picker v-model="recordTime" type="daterange" align="right" unlink-panels range-separator="至"
			...
			<div>
				<el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName" height="600" border>
